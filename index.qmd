...
| Block   | From   | To     | Topic                                                                    |
+=========+========+========+==========================================================================+
| Block 1 | 14:00  | 16:00  | -   [General introduction](slides/slides_introduction.html#/title-slide) |
|         |        |        |                                                                          |
|         |        |        | -   [Introduction to Quarto](slides/slides_quarto.html#/title-slide)     |
+---------+--------+--------+--------------------------------------------------------------------------+
| BREAK   | 16:00  | 16:15  |                                                                          |
+---------+--------+--------+--------------------------------------------------------------------------+
| Block 2 | 16:15  | 18:00  | -   [Exercises - Quarto](exercises_quarto.qmd)                              |
+---------+--------+--------+--------------------------------------------------------------------------+
...
| Block   | From  | To    | Topic                                                                     |
+=========+=======+=======+===========================================================================+
| Block 3 | 14:00 | 16:00 | -   [Introduction to git and GitHub](slides/slides_git.html#/title-slide) |
|         |       |       |                                                                           |
|         |       |       | -   [Exercises on git, GitHub and GitHub pages](slides/slides_git.html)    |
+---------+-------+-------+---------------------------------------------------------------------------+
| BREAK   | 16:00 | 16:15 |                                                                           |
+---------+-------+-------+---------------------------------------------------------------------------+
| Block 4 | 16:15 | 18:00 | -   [Introduction to Zenodo](slides/slides_zenodo.qmd)                    |
|         |       |       |                                                                           |
