...
| Block   | Topic                                                                     |
+=========+===========================================================================+
| Block 1 | -   [General introduction](slides/slides_introduction.html#/title-slide)  |
|         |                                                                           |
...
| BREAK   |                                                                           |
+---------+---------------------------------------------------------------------------+
| Block 3 | -   [Introduction to git and GitHub](slides/slides_git.html#/title-slide) |
|         |                                                                           |
|         | -   [Exercises on git, GitHub and GitHub pages](exercises_git.qmd)        |
+---------+---------------------------------------------------------------------------+
| BREAK   |                                                                           |
+---------+---------------------------------------------------------------------------+
| Block 4 | -   [Introduction to Zenodo](slides/slides_zenodo.qmd)                    |
|         |                                                                           |
