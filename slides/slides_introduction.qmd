...
- *Reproducibility:* The principle that states that results ... should be achieved again with a high degree of reliability when the study/analysis is replicated.
