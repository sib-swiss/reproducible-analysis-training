...
![](https://upload.wikimedia.org/wikipedia/commons/9/91/Octicons-mark-github.svg){height=1in fig-align="center"}
...
-   microsoft owned (with an opensource origin)
-   quite public/big-collaboration oriented
...
![](https://upload.wikimedia.org/wikipedia/commons/c/c8/GitLab_logo_%282%29.svg){height=1in fig-align="center"}

[gitlab](http://gitlab.com): 

::: {style="font-size: 70%;"}

-   self-owned, with an opensource community edition
-   very complete DevOps, CI/CD, security group setups
-   often institution have their own gitlab server 
